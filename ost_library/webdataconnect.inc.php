...
*/
// http://192.168.1.34/gah-ost/gahscart
   $host = "192.168.1.34";  // the server where the database resides
   $user = "fgl";           // sandbox user login
   $pw = "welcome";         // sandbox password
   $database = "gah_ost";   // my database, same userid as sandbox login
